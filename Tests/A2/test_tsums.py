...
def test01(time_sum):
    """time_sum(0, 0)"""
    return run_test(time_sum, 0, 0), "0000"

def test02(time_sum):
    """time_sum(13, 0)"""
    return run_test(time_sum, 13, 0), "0013"

def test03(time_sum):
    """time_sum(59, 1)"""
    return run_test(time_sum, 59, 1), "0100"

def test04(time_sum):
    """time_sum(59, 7)"""
    return run_test(time_sum, 59, 7), "0106"

def test05(time_sum):
    """time_sum(123, 7)"""
    return run_test(time_sum, 123, 7), "0130"

def test06(time_sum):
    """time_sum(3, 2357)"""
    return run_test(time_sum, 3, 2357), "2400"

def test07(time_sum):
    """time_sum(1708, 959)"""
    return run_test(time_sum, 1708, 959), "2707"
...
def set_up_tests():
    mts = ModuleTestSetup('tsums.py')
    fts = FunctionTestSetup(mts, 'time_sum', 'test')
