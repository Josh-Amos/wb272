...
def test01(category):
    """category(1.9)"""
    return run_test(category, 1.9), 'micro'

def test02(category):
    """category(2.9)"""
    return run_test(category, 2.9), 'micro'

def test03(category):
    """category(2.95)"""
    return run_test(category, 2.95), 'minor'

def test04(category):
    """category(3.0)"""
    return run_test(category, 3.0), 'minor'

def test05(category):
    """category(3.01)"""
    return run_test(category, 3.01), 'minor'

def test06(category):
    """category(3.94)"""
    return run_test(category, 3.94), 'minor'

def test07(category):
    """category(3.99)"""
    return run_test(category, 3.99), 'light'

def test08(category):
    """category(4)"""
    return run_test(category, 4), 'light'

def test09(category):
    """category(4.5)"""
    return run_test(category, 4.5), 'light'

def test10(category):
    """category(4.97)"""
    return run_test(category, 4.97), 'moderate'

def test11(category):
    """category(5.01)"""
    return run_test(category, 5.01), 'moderate'

def test12(category):
    """category(5.9)"""
    return run_test(category, 5.9), 'moderate'

def test13(category):
    """category(6)"""
    return run_test(category, 6), 'strong'

def test14(category):
    """category(6.7)"""
    return run_test(category, 6.7), 'strong'

def test15(category):
    """category(6.94999)"""
    return run_test(category, 6.94999), 'strong'

def test16(category):
    """category(6.95001)"""
    return run_test(category, 6.95001), 'major'

def test17(category):
    """category(7)"""
    return run_test(category, 7), 'major'

def test18(category):
    """category(7.9)"""
    return run_test(category, 7.9), 'major'

def test19(category):
    """category(8.0)"""
    return run_test(category, 8.0), 'great'

def test20(category):
    """category(9.5)"""
    return run_test(category, 9.5), 'great'
...
def set_up_tests():
    mts = ModuleTestSetup('richter.py')
    fts = FunctionTestSetup(mts, 'category', 'test')
    return mts
