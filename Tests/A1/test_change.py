...
def test01(get_change):
    '''due = 10, tendered = 10, which expects 0, 0, 0'''
    r5, r2, r1 = get_change(10, 10)
    return r5 == 0 and r2 == 0 and r1 == 0

def test02(get_change):
    '''due = 3, tendered = 10, which expects 1, 1, 0'''
    r5, r2, r1 = get_change(3, 10)
    return r5 == 1 and r2 == 1 and r1 == 0

def test03(get_change):
    '''due = 7, tendered = 10, which expects 0, 1, 1'''
    r5, r2, r1 = get_change(7, 10)
    return r5 == 0 and r2 == 1 and r1 == 1

def test04(get_change):
    '''due = 4, tendered = 10, which expects 1, 0, 1'''
    r5, r2, r1 = get_change(4, 10)
    return r5 == 1 and r2 == 0 and r1 == 1

def test05(get_change):
    '''due = 5, tendered = 10, which expects 1, 0, 0'''
    r5, r2, r1 = get_change(5, 10)
    return r5 == 1 and r2 == 0 and r1 == 0

def test06(get_change):
    '''due = 8, tendered = 10, which expects 0, 1, 0'''
    r5, r2, r1 = get_change(8, 10)
    return r5 == 0 and r2 == 1 and r1 == 0

def test07(get_change):
    '''due = 9, tendered = 10, which expects 0, 0, 1'''
    r5, r2, r1 = get_change(9, 10)
    return r5 == 0 and r2 == 0 and r1 == 1

def test08(get_change):
    '''due = 10, tendered = 20, which expects 2, 0, 0'''
    r5, r2, r1 = get_change(10, 20)
    return r5 == 2 and r2 == 0 and r1 == 0

def test09(get_change):
    '''due = 6, tendered = 10, which expects 0, 2, 0'''
    r5, r2, r1 = get_change(6, 10)
    return r5 == 0 and r2 == 2 and r1 == 0

def test10(get_change):
    '''due = 2, tendered = 10, which expects 1, 1, 1'''
    r5, r2, r1 = get_change(2, 10)
    return r5 == 1 and r2 == 1 and r1 == 1
...
def set_up_tests():
    mts = ModuleTestSetup('change.py')
    fts = FunctionTestSetup(mts, 'get_change', 'test')
