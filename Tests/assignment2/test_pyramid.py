...
def test01(volume):
    """volume(10, 2, 3) == '6.667'"""
    return volume(10, 2, 3) == '6.667'

def test02(volume):
    """volume(100, 2, 3) == '66.667'"""
    return volume(100, 2, 3) == '66.667'

def test03(volume):
    """volume(100, 2, 4) == '66.6667'"""
    return volume(100, 2, 4) == '66.6667'

def test04(volume):
    """volume(17.5, 11.5, 11) == '67.08333333333'"""
    return volume(17.5, 11.5, 11) == '67.08333333333'

def test05(volume):
    """Great Pyramid of Giza: volume(53084.16, 146.5, 7) == '2592276.4800000'"""
    return volume(53084.16, 146.5, 7) == '2592276.4800000'
...
def set_up_tests():
    mts = ModuleTestSetup('pyramid.py')
    fts = FunctionTestSetup(mts, 'volume', 'test')
    fts.set_illegal_statements(['If', 'Import', 'ImportFrom', 'For', 'Slice',
        'While'])
    fts.set_illegal_calls(['round', 'index', 'find', 'sort', 'sorted'])
