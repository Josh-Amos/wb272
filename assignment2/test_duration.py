...
def ric(start_time, duration):
    return RawInputCapture({"Duration:": duration, "Start time:": start_time})

### test cases #################################################################

def test01(end_time):
    '''end_time() with start time 0000 and duration 30'''
    with raw_input_capture(ric('0000', 30)), time_limit(1):
        return end_time() == '0030'

def test02(end_time):
    '''end_time() with start time 0000 and duration 100'''
    with raw_input_capture(ric('0000', 100)), time_limit(1):
        return end_time() == '0140'

def test03(end_time):
    '''end_time() with start time 0800 and duration 300'''
    with raw_input_capture(ric('0800', 300)), time_limit(1):
        return end_time() == '1300'

def test04(end_time):
    '''end_time() with start time 1757 and duration 240'''
    with raw_input_capture(ric('1757', 240)), time_limit(1):
        return end_time() == '2157'

def test05(end_time):
    '''end_time() with start time 2330 and duration 90'''
    with raw_input_capture(ric('2330', 90)), time_limit(1):
        return end_time() == '0100'
...
def set_up_tests():
    mts = ModuleTestSetup('duration.py')
    fts = FunctionTestSetup(mts, 'end_time', 'test')
