...
def test00(isbn10to13):
    """isbn10to13("0743477553")"""
    return run_test(isbn10to13, "0743477553"), "9780743477550"

def test01(isbn10to13):
    """isbn10to13("0743482859")"""
    return run_test(isbn10to13, "0743482859"), "9780743482851"

def test02(isbn10to13):
    """isbn10to13("0743482751")"""
    return run_test(isbn10to13, "0743482751"), "9780743482752"

def test03(isbn10to13):
    """isbn10to13("074347712X")"""
    return run_test(isbn10to13, "074347712X"), "9780743477123"

def test04(isbn10to13):
    """isbn10to13("1903436001")"""
    return run_test(isbn10to13, "1903436001"), "9781903436004"

def test05(isbn10to13):
    """isbn10to13("014028592X")"""
    return run_test(isbn10to13, "014028592X"), "9780140285925"

def test06(isbn10to13):
    """isbn10to13("1903436486")"""
    return run_test(isbn10to13, "1903436486"), "9781903436486"

def test07(isbn10to13):
    """isbn10to13("0743477561")"""
    return run_test(isbn10to13, "0743477561"), "9780743477567"

def test08(isbn10to13):
    """isbn10to13("1904271332")"""
    return run_test(isbn10to13, "1904271332"), "9781904271338"

def test09(isbn10to13):
    """isbn10to13("074348276X")"""
    return run_test(isbn10to13, "074348276X"), "9780743482769"
...
def set_up_tests():
    ...
    fts = FunctionTestSetup(mts, 'isbn10to13', 'test')
