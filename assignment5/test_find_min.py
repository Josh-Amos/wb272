...
def test01(find_min):
    """findmin([1, 2, 3, 4, 5], 0)"""
    return run_test(find_min, [1, 2, 3, 4, 5], 0), 0

def test02(find_min):
    """findmin([1, 2, 3, 4, 5], 1)"""
    return run_test(find_min, [1, 2, 3, 4, 5], 1), 1

def test03(find_min):
    """findmin([1, 2, 3, 4, 5], 2)"""
    return run_test(find_min, [1, 2, 3, 4, 5], 2), 2

def test04(find_min):
    """findmin([1, 2, 3, 4, 5], 3)"""
    return run_test(find_min, [1, 2, 3, 4, 5], 3), 3

def test05(find_min):
    """findmin([1, 2, 3, 4, 5], 4)"""
    return run_test(find_min, [1, 2, 3, 4, 5], 4), 4

def test06(find_min):
    """findmin([5, 4, 3, 2, 1], 0)"""
    return run_test(find_min, [5, 4, 3, 2, 1], 0), 4

def test07(find_min):
    """test 100 random integers"""
    L = [random.randint(-1000000, 1000000) for i in range(100)]
    min_index = L.index(min(L))
    return run_test(find_min, L, 0), min_index
...
def set_up_tests():
    mts = ModuleTestSetup('find.py')
    fts = FunctionTestSetup(mts, 'find_min', 'test')
    fts.set_legal_calls([
        'len',
        'range',
    ])
