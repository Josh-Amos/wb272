...
def test01(sort3):
    """sort3(2, 3, 5)"""
    with nostdout(): a, b, c = sort3(2, 3, 5)
    return a == 2 and b == 3 and c == 5

def test02(sort3):
    """sort3(2, 5, 3)"""
    with nostdout(): a, b, c = sort3(2, 5, 3)
    return a == 2 and b == 3 and c == 5

def test03(sort3):
    """sort3(3, 2, 5)"""
    with nostdout(): a, b, c = sort3(3, 2, 5)
    return a == 2 and b == 3 and c == 5

def test04(sort3):
    """sort3(3, 5, 2)"""
    with nostdout(): a, b, c = sort3(3, 5, 2)
    return a == 2 and b == 3 and c == 5

def test05(sort3):
    """sort3(5, 2, 3)"""
    with nostdout(): a, b, c = sort3(5, 2, 3)
    return a == 2 and b == 3 and c == 5

def test06(sort3):
    """sort3(5, 3, 2)"""
    with nostdout(): a, b, c = sort3(5, 3, 2)
    return a == 2 and b == 3 and c == 5

def test07(sort3):
    """sort3(3, 2, -5)"""
    with nostdout(): a, b, c = sort3(3, 2, -5)
    return a == -5 and b == 2 and c == 3
...
def set_up_tests():
    mts = ModuleTestSetup('sort3.py')
    fts = FunctionTestSetup(mts, 'sort3', 'test')
