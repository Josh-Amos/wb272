...
def test00(isbn13_to_10):
    """isbn13_to_10("9780743482844")"""
    return run_test(isbn13_to_10, "9780743482844"), "0743482840"

def test01(isbn13_to_10):
    """isbn13_to_10("9780671722920")"""
    return run_test(isbn13_to_10, "9780671722920"), "0671722921"

def test02(isbn13_to_10):
    """isbn13_to_10("9781904271338")"""
    return run_test(isbn13_to_10, "9781904271338"), "1904271332"

def test03(isbn13_to_10):
    """isbn13_to_10("9781903436615")"""
    return run_test(isbn13_to_10, "9781903436615"), "1903436613"

def test04(isbn13_to_10):
    """isbn13_to_10("9780521618755")"""
    return run_test(isbn13_to_10, "9780521618755"), "0521618754"

def test05(isbn13_to_10):
    """isbn13_to_10("9780141012315")"""
    return run_test(isbn13_to_10, "9780141012315"), "0141012315"

def test06(isbn13_to_10):
    """isbn13_to_10("9780192802354")"""
    return run_test(isbn13_to_10, "9780192802354"), "0192802356"

def test07(isbn13_to_10):
    """isbn13_to_10("9780199535811")"""
    return run_test(isbn13_to_10, "9780199535811"), "0199535817"

def test08(isbn13_to_10):
    """isbn13_to_10("9780230200951")"""
    return run_test(isbn13_to_10, "9780230200951"), "0230200958"

def test09(isbn13_to_10):
    """isbn13_to_10("9780760703328")"""
    return run_test(isbn13_to_10, "9780760703328"), "0760703329"

def test10(isbn13_to_10):
    """isbn13_to_10("9781587155017")"""
    return run_test(isbn13_to_10, "9781587155017"), "158715501X"
...
def set_up_tests():
    mts = ModuleTestSetup('isbn.py')
    fts = FunctionTestSetup(mts, 'isbn13_to_10', 'test')
